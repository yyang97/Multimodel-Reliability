...
save(failmat, file = paste0("GPprobwind_", phi, ".rda"))
...
# 
# 
# quantile(probwind_2[,1],probs = c(0.025,.5,0.975))
# quantile(USprobwind_2[,1],probs = c(0.025,.5,0.975))
# 
# 
# 
